...
pub trait SliceInput<'a>: ExactSizeInput<'a> {
    ...
    // TODO: Make unsafe to allow extra optimisations by the implementor
    #[doc(hidden)]
...
/// An input wrapper containing a user-defined context in its span, in addition to the span of the wrapped input. See
/// [`Input::with_context`].
#[derive(Copy, Clone)]
...
impl<'a, 'parse, I: Input<'a>, E: ParserExtra<'a, I>> InputRef<'a, 'parse, I, E> {
    ...
    where
        I: SliceInput<'a> + ExactSizeInput<'a>,
    {
